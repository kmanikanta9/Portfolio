...
export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            <img src={profile_img} alt="" className="rounded-full border-black w-32" />
            <h3 className="flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo">
                Hi! I&apos;Manikanta Kondakayala
                <img src="./assets/hand-icon.png" alt="" className="w-6 mb-1" />
            </h3>
            {/* <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">frontend web developer based in London.</h1> */}
            <p className="max-w-2xl mx-auto font-Ovo">I'm a passionate web developer skilled in JavaScript, React, Node.js, and MongoDB. I build scalable, real-world applications and love solving problems.</p>
